...
namespace Mono.Linker.Tests.Cases.RequiresCapability
{
	...
	class RequiresAccessedThrough
	{
		...
		[ExpectedWarning ("IL3050", "--RequiresOnlyThroughReflection--", ProducedBy = ProducedBy.Analyzer | ProducedBy.NativeAot)]
		...
		class AccessedThroughReflectionOnGenericType<T>
		{
			...
			[ExpectedWarning ("IL3050", "--GenericType.RequiresOnlyThroughReflection--", ProducedBy = ProducedBy.NativeAot)]
		...
		class AccessThroughLdToken
		{
			...
			[ExpectedWarning ("IL3050", "--PropertyWithLdToken.get--", ProducedBy = ProducedBy.Analyzer | ProducedBy.NativeAot)]
			public static void Test ()
			{
