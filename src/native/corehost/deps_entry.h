...
struct deps_entry_t
{
    ...
    bool to_dir_path(const pal::string_t& base, bool look_in_bundle, pal::string_t* str, bool& found_in_bundle, bool avoid_fs_check) const;

    // Given a "base" dir, yield the relative path in the package layout or servicing directory.
    bool to_rel_path(const pal::string_t& base, bool look_in_bundle, bool is_servicing, pal::string_t* str, bool avoid_fs_check) const;
...
private:
    ...
    bool to_path(const pal::string_t& base, const pal::string_t& ietf_code, bool look_in_base, bool look_in_bundle, bool is_servicing, pal::string_t* str, bool & found_in_bundle, bool avoid_fs_check) const;
